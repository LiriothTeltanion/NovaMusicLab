        ...
        >
          <div className="flex items-start gap-3 min-w-0">
            ...
            <div className="space-y-2 min-w-0">
              ...
              <h3 className="text-base md:text-lg font-black text-white leading-tight">{title}</h3>
              {expanded && <p className="text-sm text-gray-300 leading-relaxed max-w-4xl">{subtitle}</p>}
            </div>
          </div>
          <span className="flex items-center gap-2 shrink-0 mt-1">
            ...
            <ChevronDown className={`w-4 h-4 transition-transform duration-300 ${expanded ? 'rotate-180' : ''}`} style={{ color }} />
          </span>
        </button>
