              ...
              <div key={sess.id} className="p-4 bg-cyan-950/10 border border-cyan-500/10 rounded-2xl hover:border-cyberPink/40 transition-all space-y-3">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <span className="text-xs font-bold text-white">{formatDate(sess.start)} {new Date(sess.start).toLocaleTimeString(localeFor(lang), {hour: '2-digit', minute:'2-digit'})}</span>
                  </div>
