...
const EMOTION_DETAILS = {
  ...
  energia: {
    ...
    tracks: ["MANTRA", "Prayers", "To Better Days", "Ritual"],
    trackNotes: {
      es: ["Declaración de control y energía combativa.", "Catarsis emocional frontal.", "Empuje post-hardcore hacia la recuperación.", "Golpe ritual para activar el cuerpo."],
      en: ["Statement of control and combative energy.", "Direct emotional catharsis.", "Post-hardcore push toward recovery.", "Ritual hit to activate the body."],
    },
    color: "#f72585",
  },
  dopamina: {
    ...
    tracks: ["2016 CAVALIERS (Ohio)", "Tokyo", "Last Young Renegade", "Aperol Spritz"],
    trackNotes: {
      es: ["Groove absurdo y reconstrucción con sonrisa.", "Energía moderna de pop-punk digital.", "Pop-punk himno de juventud y reinvención.", "Ligereza de tarde y movimiento social."],
      en: ["Absurd groove and rebuilding with a smile.", "Modern digital pop-punk energy.", "Anthemic pop-punk youth and reinvention.", "Afternoon lightness and social motion."],
    },
    color: "#ffb703",
  },
  calma: {
  ...
  futurismo: {
    ...
    tracks: ["Turbo Killer", "Near Dark", "Vampires", "Neo Tokyo"],
    trackNotes: {
      es: ["Velocidad cyberpunk y persecución mental.", "Crepúsculo vampírico en autopista synth analógica.", "Carretera nocturna con corazón nostálgico.", "Ciudad futura como refugio."],
      en: ["Cyberpunk speed and mental chase.", "Vampiric dusk on an analog synth highway.", "Nocturnal highway with nostalgic heart.", "Future city as refuge."],
    },
    color: "#7209b7",
  },
  romanticismo: {
