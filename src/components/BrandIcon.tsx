...
export default function BrandIcon({ name, className = '', size = 16, color }: BrandIconProps) {
  ...
  switch (norm) {
    case 'spotify':
      return (
        <svg {...accessibilityProps} viewBox="0 0 24 24" width={size} height={size} fill={fill} className={className}>
    ...
    case 'youtubemusic':
      return (
        <svg {...accessibilityProps} viewBox="0 0 24 24" width={size} height={size} fill="none" className={className}>
          <circle cx="12" cy="12" r="10" fill={fill} />
          <circle cx="12" cy="12" r="6.25" stroke="white" strokeWidth="1.5" />
          <path d="M10 8.8v6.4l5-3.2-5-3.2z" fill="white" />
        </svg>
      );
    case 'bandcamp':
      return (
    ...
    case 'instagram':
      return (
        <svg {...accessibilityProps} viewBox="0 0 24 24" width={size} height={size} fill="none" stroke={fill} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    case 'listenbrainz':
      return (
        <svg {...accessibilityProps} viewBox="0 0 24 24" width={size} height={size} fill="none" className={className}>
          <path d="M12 2.8 3.2 7.9v8.2l8.8 5.1 8.8-5.1V7.9L12 2.8Z" stroke={fill} strokeWidth="1.7" />
          <path d="M8.2 9.2v5.6M11 7.7v8.6M13.8 9v6M16.6 10.5v3" stroke={fill} strokeWidth="1.8" strokeLinecap="round" />
        </svg>
      );
    case 'musicbee':
      return (
        <svg {...accessibilityProps} viewBox="0 0 24 24" width={size} height={size} fill="none" className={className}>
          <path d="m12 2.5 8.2 4.75v9.5L12 21.5l-8.2-4.75v-9.5L12 2.5Z" fill={fill} />
          <path d="M8.2 9.2h7.6M7.5 12h9M8.2 14.8h7.6" stroke="#111827" strokeWidth="1.6" strokeLinecap="round" />
          <circle cx="9" cy="7.4" r="1" fill="#111827" />
          <circle cx="15" cy="7.4" r="1" fill="#111827" />
        </svg>
      );
    case 'wikipedia':
    case 'wikidata':
