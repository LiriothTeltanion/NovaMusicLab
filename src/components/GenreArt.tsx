...
const PALETTES: Record<string, GenrePalette> = {
  ...
  'Power / Speed Metal':    { from: '#7f1d1d', via: '#f59e0b', to: '#fde68a', pattern: 'bolt' },
  'Folk Metal':             { from: '#14532d', via: '#65a30d', to: '#d9f99d', pattern: 'horns' },
  'Alt-Metal':              { from: '#1e1b4b', via: '#6d28d9', to: '#c4b5fd', pattern: 'bolt' },
