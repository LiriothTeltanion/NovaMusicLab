...
The current stable product line is **v1.5.0 — deployed 2026-08-01**. The number **4** below is the IndexedDB schema version only; it is not the application's product version.
