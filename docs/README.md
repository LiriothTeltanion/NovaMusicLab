# Nova Music Lab documentation

The repository root README is the product entrance. Detailed decisions live here:

- [`product/`](./product/) — audience, experience and roadmap contracts.
- [`design/`](./design/) — accessibility and visual-system rules.
- [`architecture/`](./architecture/) — runtime, storage, privacy, social and connector decisions.
- [`data/`](./data/) — public bundle, artist knowledge and visual-asset provenance.
- [`operations/`](./operations/) — quality gates and release procedures.
